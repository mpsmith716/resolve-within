          ...
          {submitted ? (
            ...
            <View style={styles.successContainer}>
              ...
              <Text style={styles.successText}>
                Thank you. Your report was submitted and will be reviewed when possible. This is not emergency monitoring — for crisis support, call or text 988.
              </Text>
            </View>
          ) : (
            /* ── Form state ── */
            ...
            >
              <Text style={styles.description}>
                Use this form to report a safety concern about community content. Reports are reviewed when possible, but this is not emergency response and posts are not continuously monitored. If you or someone else is in crisis, call or text 988 (US) or use local emergency resources.
              </Text>
