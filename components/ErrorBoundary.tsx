...
import { View, Text, Pressable, StyleSheet, ScrollView, Platform, SafeAreaView, Modal, TouchableOpacity, ActivityIndicator } from "react-native";
      ...
      >
        <TouchableOpacity activeOpacity={1} onPress={() => {}}>
          <View style={appModalStyles.card}>
            ...
            {message ? <Text style={appModalStyles.message}>{message}</Text> : null}
            <View style={appModalStyles.actionsRow}>
              {actions.map((action, index) => {
                ...
                return (
                  <TouchableOpacity
                    key={index}
                    style={appModalStyles.actionButton}
                    onPress={() => {
                      console.log('[AppModal] action pressed:', action.label);
                      action.onPress();
                    }}
                  ...
                  >
                    {action.loading ? (
                      ...
                      <Text style={[appModalStyles.actionText, { color: textColor }]}>
                        {action.label}
                      </Text>
                    )}
                  </TouchableOpacity>
